...
# releases stay individually addressable) and once as ColdStorage-macOS-arm64.dmg.
...
TITLE="${2:-Cold Storage ${TAG#v}}"
NOTES="${3:-}"
STABLE_NAME="ColdStorage-macOS-arm64.dmg"
...
APPVER=$(/usr/libexec/PlistBuddy -c "Print :CFBundleShortVersionString" \
  "app/release/mac-arm64/Cold Storage.app/Contents/Info.plist")
